    ...
    float4 positionWorld)
{
    ...
    unityShadowCoord3 lightCoord = mul(unity_WorldToLight, positionWorld).xyz;
    ...
    half shadow)
{
    ...
    d.shadow = shadow;
        ...
        unityShadowCoord2 lightCoord = mul(unity_WorldToLight, unityShadowCoord4(s.positionWorld, 1)).xy;
    ...
    lightAxis = normalize(unity_WorldToLight[1].xyz);
            ...
            unityShadowCoord3 lightCoord = mul(unity_WorldToLight, unityShadowCoord4(s.positionWorld, 1)).xyz;
    ...
    #ifdef SPOT
        unityShadowCoord4 lightCoord = mul(unity_WorldToLight, unityShadowCoord4(s.positionWorld, 1));

...
ADirect aDeferredDirect(ASurface s)
{
    ...
    // directional light
        ...
        lightVector = -_LightDir.xyz;
            ...
            half4 cookie = tex2Dbias(_LightTexture0, float4(mul(unity_WorldToLight, half4(s.positionWorld, 1)).xy, 0, -8));
    ...
    // spot & point lights
        ...
        // point light
            ...
            // light cookie
                ...
                half4 cookie = texCUBEbias(_LightTexture0, float4(mul(unity_WorldToLight, half4(s.positionWorld, 1)).xyz, -8));
                d.color *= A_LIGHT_COOKIE(cookie);
            #endif
